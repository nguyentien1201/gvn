...
class UpdateCustomerRequest extends FormRequest
{
    ...
    {
        return [
            'phone_number' => 'required|unique:customers,phone_number,' . request('id') . ',id,deleted_at,NULL',
            'first_name' => 'required',
            'last_name' => 'required',
            'email' => 'nullable|email|unique:customers,email,' . request('id') . ',id,deleted_at,NULL',
        ];
