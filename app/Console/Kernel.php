...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('sync:vnindex')->dailyAt('03:00')->withoutOverlapping(10);
        $schedule->command('sync:vnindex')->dailyAt('05:00')->withoutOverlapping(10);
        $schedule->command('sync:vnindex')->dailyAt('07:00')->withoutOverlapping(10);
        $schedule->command('sync:vnindex')->dailyAt('09:00')->withoutOverlapping(10);
