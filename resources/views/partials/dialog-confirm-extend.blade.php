...
<div class="modal fade" id="confirmExtend" tabindex="-1" role="dialog" aria-labelledby="confirmExtendModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-sm modal-lg modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5 style="text-align:center" id="product_name"></h5>
                <input type="hidden" id="sub_price_id" value="">
                <input type="hidden" id="product_id" value="">
                <div class="container pb-3 mt-3 pt-1" style="background: #f9f9f9;">
                    <div class="row">
...
<script>
    $(document).ready(function () {
        ...
        $('.ptable-action .subscription').click(function (e) {
            ...
            var userConfirmed = confirm("Bạn có chắc chắn muốn gia hạn dịch vụ?");

            if (userConfirmed) {
                // Nếu người dùng nhấn OK, thực hiện hành động
                $.ajax({
                ...
                // Thực hiện các hành động khác tại đây, như gọi AJAX hoặc điều hướng
            } else {
                // Nếu người dùng nhấn Cancel, ngăn chặn hành động mặc định

                event.preventDefault(); // Ngăn chặn các hành động khác (nếu cần thiết)
            }
