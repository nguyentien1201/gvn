    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="add-edit-frm" action="{{route('admin.promotions.update', $promotion->id)}}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="title"
                                       value="{{old('title', $promotion->title)}}" autocomplete="off"
                            ...
                            <div class="col-md-6 form-group">
                                    ...
                                    @foreach($customers as $customer)
                                        @if($customer->phone_number)
                                            <option value="{{$customer->id}}"
                                                    @if($customerIds) @if(in_array($customer->id, $customerIds)) selected @endif @endif>
                                ...
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="cb-all-customer" @if(isset($promotion->is_all_customer)) checked @endif>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <div class="input-group date-time" id="execution_time"
                                    ...
                                    <input type="text" data-target="#execution_time" name="execution_time"
                                           value="{{old('execution_time', $promotion->execution_time ? date('m/d/Y H:i', strtotime($promotion->execution_time)) : '')}}"
                                           autocomplete="off"
                        ...
                        <div class="row">
                            <div class="col-md-8 form-group">
                                ...
                                <textarea id="message" rows="4" name="message" autocomplete="off"
                                          ...
                                          placeholder="{{__('promotion.message_place')}}">{{old('message', $promotion->message)}}</textarea>
