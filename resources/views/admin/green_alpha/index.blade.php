            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                        <form class="d-flex justify-content-center" action="{{route('admin.green-alpha.import')}}" method="post"
                            ...
                            @forelse($signals as $idx => $signal)
                                <tr>
                                    ...
                                    <td width="10%" class="text-center text-nowrap">
                                        <a href="{{ route('admin.green-alpha.edit', [$signal->id]) }}"
                                        ...
                                        <a href="#confirmDelete" data-toggle="modal"
                                           ...
                                           data-id="{{$signal->id}}"
                                           data-action="{{ route('admin.green-alpha.destroy', [$signal->id])}}"
