    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="add-edit-frm" action="{{route('admin.stock-green-beta.store')}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" name="code" autocomplete="off"  placeholder="{{__('mst_stock.code')}}"
                                ...
                                <select
                                    ...
                                    name="group" autocomplete="off">
                                        ...
                                        @foreach($listGroup as $key=> $group)
                                            <option value="{{$group}}"
                                                @if(old('group') == $group) selected @endif>{{$group}}</option>
                                        @endforeach
