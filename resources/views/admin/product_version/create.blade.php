...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">{{__('panel.add_product')}}</div>
                <div class="card-body">
                    <form class="add-edit-frm" action="{{route('admin.product-version.store')}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 form-group">
                                ...
                                <div class="input-group date-time" id="release_date"
                                    ...
                                    <input type="text" data-target="#release_date" name="release_date"
                                           value="{{old('release_date')}}" autocomplete="off"
                            ...
                            <div class="col-md-2 form-group">
                                ...
                                <div class="input-group">
                                    <input type="checkbox" id="toggle" name="is_current">
