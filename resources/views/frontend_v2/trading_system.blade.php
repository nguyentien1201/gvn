					...
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active btn-tab me-2" id="pills-green-beta-tab"
								...
								aria-selected="true">Green Beta</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link btn-tab" id="pills-green-alpha-tab" data-bs-toggle="pill"
								...
								aria-selected="false">Green Alpha</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link btn-tab" id="pills-green-stock-tab" data-bs-toggle="pill"
								...
								aria-controls="pills-green-stock"
								aria-selected="false">Green Stock</button>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="tab-content" id="pills-tabContent">
				<div class="tab-pane fade show active" id="pills-green-beta" role="tabpanel"
					...
					<div class="container text-center py-5">
						...
						<div class="banner-container mx-auto mb-4">
							<img src="{{asset('images/banner-beta.png')}}" alt="GVN Banner" class="img-fluid w-100 rounded-banner" />


						</div>

						<div class="noto-sans-jp-font-family my-3 text-muted mb-3" style=" margin: 0 auto;">
							Identifying the correct trend is the golden key that opens the door to success in trading and accounts for up to 70% of the chance of winning. Getting the right market trend is a key factor for every investor in the financial market. GVN’s Green Beta Robot is a combined engineering of searching for bullish trends with smart algorithms and self-adapting when market trends show signs of change. With an average trend prediction accuracy rate of 70-80%, Green Beta Robot is a great assistant for every investor.
						</div>

						<div class=" noto-sans-jp-font-family my-3 fw-medium" style=" margin: 0 auto;">
							Green Beta is able to work on different 20 indicators in Stock, Commodity and Cryptocurrency markets, giving investors a holistic view of the changing trends of shark’s money flow in the global market.
						</div>
				...
				<div class="tab-pane fade" id="pills-green-alpha" role="tabpanel"
					...
					<div class="container-tab-heading">
						<div class="container text-center py-5">
							<h2 class="mb-4">“It’s not whether you’re right or wrong, but how much money you make when you’re right and how much you lose when you’re wrong.”
							...
							<div class="row align-items-center g-4 flex-column-reverse flex-md-row">
								<div class="col-md-6 col-6">
									<p class="text-secondary fs-6">
										...
										GVN's Green Alpha Robot will be a powerful tool to help you master your emotions, make disciplined trading decisions and achieve high efficiency in Trading.
										GVN's Green Alpha Robot analyzes the market's momentum during the session, identifies trends and gives specific trading actions.
										Green Beta Robot is suitable for Day trader in the markets.
									</p>
								</div>
								<div class="col-md-6">
									<div class="banner-container mx-auto mb-4">
										<img src="{{asset('images/banner-alpha.png')}}" alt="GVN Banner" class="img-fluid w-100 rounded-banner" />
									</div>
								</div>
							</div>
				...
				<div class="tab-pane fade" id="pills-green-stock" role="tabpanel"
					...
					<div class="container-tab-heading">
						<div class="container text-center py-5">
							<h2 class="mb-4">“Instead of predicting the market, let focus on finding investment opportunities.”
								<h3 class="text-success">John Templeton</h3>
							</h2>
							<div class="row align-items-center g-4 flex-column-reverse flex-md-row">
								<div class="col-md-6 col-6">
									<p class="text-secondary fs-6">
										The GreenStock-NAS100 system automatically sorts stocks by cash flow momentum strength and stock trends in the NAS100 index daily, provides actions for investors to update.
									</p>
								</div>
								<div class="col-md-6">
									<div class="banner-container mx-auto mb-4">
										<img src="{{asset('images/device.png')}}" alt="GVN Banner" class="img-fluid w-100 rounded-banner" />
									</div>
								</div>
							</div>
							<div class="row align-items-center g-4 flex-column-reverse flex-md-row">
								<div class="col-md-6 col-6">
									<div class="banner-container mx-auto mb-4">
										<img src="{{asset('images/greenstock-banner-2.png')}}" alt="GVN Banner" class="img-fluid w-100 rounded-banner" />
									</div>
								</div>
								<div class="col-md-6">
									<p class="text-secondary fs-6">
