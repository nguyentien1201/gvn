<section id="trading-green-stock-NAS100">
    <div class="container">
        <h2 class="text-center NAS100-title">{{__('base.vnindex_trading_on')}}</h2>
                            ...
                            <div class="col-12">
                                <div class="container-chart">
                                    ...
                                    <div style="height: 363px;"
                                        ...
                                        <canvas id="pieChart-vnindex"></canvas>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="container-chart">
                                    ...
                                    <div style="height: 363px;"
                                         class="d-flex flex-column justify-content-center align-items-center chart-container">
                                        <canvas id="maChart_vnindex"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="container-chart">
                                    ...
                                    <div style="height: 900px;"
                                         class="d-flex flex-column justify-content-center align-items-center chart-container">
                                        <canvas id="groupStock_vnindex"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            // pie chart
            const ctx_vnindex = document.getElementById('pieChart-vnindex').getContext('2d');
            const myPieChart = new Chart(ctx_vnindex, {
                type: 'pie',
                data: {
                    labels: @json($labels_vnindex),
                    datasets: [{
                        data: @json($chart_signal_vnindex),
                        backgroundColor: [
                            '#F1C32A',
                            '#198754',
                            '#008000',
            ...
            // ma chart
            const ctxMaChart = document.getElementById('maChart_vnindex').getContext('2d');
            ...
            const maChart = new Chart(ctxMaChart, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: 'DOWN',
                            data: @json($ma_vnindex['down']),
                            backgroundColor: '#EF5657',
                        },
                        {
                            label: 'UP',
                            data: @json($ma_vnindex['up']),
            ...
            // group stock
            const barGroupctx = document.getElementById('groupStock_vnindex').getContext('2d');
            ...
            const barGroup = new Chart(barGroupctx, {
                type: 'bar',
                data: {
                    labels: @json($chart_group_data_vnindex['labels']),
                    datasets: [{
                        label: '', // Ẩn label vì không dùng
                        data: @json($chart_group_data_vnindex['rate']),
                        backgroundColor: '#008000',
                        barThickness: 20
                    }]
                },
