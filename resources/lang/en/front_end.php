...
return [
    ...
    'HOLD'=>'HOLD',
    'CASH'=>'CASH',
    'green_stock_100'=>"Trading on GREENS TOCK-NAS100",
    'description_title_green_stock'=>"Green Stock-NAS100 is a system that analyzes stocks in the pool of NASDAQ100 stocks of the US market. The system automatically analyzes short-term and long-term trends of stocks, rank trends and cash flow momentum on each stock, thereby creating a technical Rating scorecard to give users actionable insights. A circle of action in users' trading: BUY-HOLD-SELL-CASH",
